...
export default function Home() {
  return (
    <div className="p-6 m-8">
      <button className="btn btn-primary bg-sky-600 hover:bg-sky-700">Button</button>

      <div className="p-6 m-8">
        <ul className="timeline timeline-vertical">
          <li>
            <div className="timeline-start timeline-box">School</div>
          ...
          <li>
            <hr />
            <div className="timeline-start timeline-box">Work Exp</div>
            <div className="timeline-middle">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 20 20"
          ...
          <li>
            <hr />
            <div className="timeline-start timeline-box">Jobs</div>
            <div className="timeline-middle">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 20 20"
